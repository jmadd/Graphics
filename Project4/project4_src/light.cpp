...
light* makeLight(point* origin, GLfloat r, GLfloat g, GLfloat b, GLfloat amb) {
  light* m;
...
void shade(point* p, vector* n, material* m, vector* in, color* c, light* l, point* vp, int d) {
  ...
  dif = m->dif * l-> dif * cosAngBetween(L,n);
